...
import Recomended from '../../images/Recomended-hotel-1.jpg'
import Recomended1 from '../../images/Recomended-hotel-1.jpg'
import Recomended2 from '../../images/Recomended-hotel-1.jpg'
import '../../css/Home.css'
    ...
    <>
      ...
      <section className="destinos">
        <div className="contenedor">
          ...
          <ul>
            <li>
              <Link to="#" className="card-text card">
      ...
      <section className="recomendados">
        <div className="contenedor">
          ...
          <div className="cards">
            <div className="card">
              <img src={Recomended} alt="Destino 3" className="card-img" />
